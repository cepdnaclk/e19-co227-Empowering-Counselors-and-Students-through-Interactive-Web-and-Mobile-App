...
class EditMobileUser extends StatefulWidget {
  const EditMobileUser({
    super.key,
  });

  @override
  State<EditMobileUser> createState() => _EditMobileUserState();
}

class _EditMobileUserState extends State<EditMobileUser> {
  List<String> faculty = [
