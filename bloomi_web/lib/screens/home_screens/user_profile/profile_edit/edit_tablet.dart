...
class EditTabletUser extends StatefulWidget {
  const EditTabletUser({
    super.key,
  });

  @override
  State<EditTabletUser> createState() => _EditTabletUserState();
}

class _EditTabletUserState extends State<EditTabletUser> {
  List<String> faculty = [
