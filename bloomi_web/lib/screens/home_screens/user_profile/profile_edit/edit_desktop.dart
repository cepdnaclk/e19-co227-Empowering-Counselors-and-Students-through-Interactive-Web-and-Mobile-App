...
class EditDesktopUser extends StatefulWidget {
  const EditDesktopUser({
    super.key,
  });

  @override
  State<EditDesktopUser> createState() => _EditDesktopUserState();
}

class _EditDesktopUserState extends State<EditDesktopUser> {
  List<String> faculty = [
