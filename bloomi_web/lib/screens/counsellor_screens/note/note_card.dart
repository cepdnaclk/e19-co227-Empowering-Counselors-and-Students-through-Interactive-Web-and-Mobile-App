...
class NoteCardCounsellor extends StatefulWidget {
  const NoteCardCounsellor({
    super.key,
  });

  @override
  State<NoteCardCounsellor> createState() => _NoteCardCounsellorState();
}

class _NoteCardCounsellorState extends State<NoteCardCounsellor> {
    ...
    return Consumer<CounsellorRegistrationProvider>(
      builder: (context, value, child) {
        return StreamBuilder(
          stream: NoteController().getNotesByUid(
